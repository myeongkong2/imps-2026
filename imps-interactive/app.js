...
const exactTranslations = new Map(Object.entries({
  ...
  "구조": "Model",
  "전체 표본 최종 TAN과 CPT": "Full-sample final TAN and CPTs",
  ...
  "여기부터는 전체 표본으로 추정한 최종 TAN 네트워크 결과입니다. 노드에 근거를 고정했을 때 기능제한 확률이 어떻게 갱신되는지 보여줍니다.": "Final full-sample TAN: enter evidence to update the probability of functional limitation.",
